...
/**
 * gbFriend form base class.
 *
 * @method gbFriend getObject() Returns the current form's model object
 *
 * @package    gesichtbuch
 * @subpackage form
 ...
 */
abstract class BasegbFriendForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('gb_friend[%s]');
