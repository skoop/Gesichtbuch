...
class myAutoload extends sfCoreAutoload
{
   ...
   *
   * @return myAutoload myAutoload implementation instance.
   */
  static public function getInstance()
  {
    if (!isset(self::$instance))
    {
      self::$instance = new myAutoload();
    }
  ...
  /**
   * Register myAutoload in spl autoloader.
   *
   * @return void
   */
